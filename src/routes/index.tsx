      ...
      <div className="relative mx-auto h-[88vh] max-h-[920px] min-h-[640px] w-full overflow-hidden rounded-3xl">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <iframe
            ...
            src="https://www.youtube.com/embed/FSh4TtCQCLQ?autoplay=1&mute=1&loop=1&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1&playlist=FSh4TtCQCLQ&disablekb=1&iv_load_policy=3&fs=0"
